...
import { ActionIcon, Autocomplete, AutocompleteItem, Box, Flex, Group, Loader, NumberInput, Pagination, Paper, Select, Stack, Table, Text, Title } from "@mantine/core";
...
export function MapControllEmotionEditor() {
    ...
    if (_.isEmpty(sListKabupaten.value))
        return (
            <>
